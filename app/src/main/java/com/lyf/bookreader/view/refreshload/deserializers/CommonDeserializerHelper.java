...
package com.lyf.bookreader.view.refreshload.deserializers;
 ...
 */
class CommonDeserializerHelper {

  /**
   * {@link AbstractListDeserializer} implementation for a list of {@link String}s.
   */
  static final AbstractListDeserializer<String> STRING_LIST_DESERIALIZER =
   ...
   * @throws IOException
   */
  static float[] readFloatArray(JsonReader reader) throws IOException {
   ...
   * @throws IOException
   */
  static float[][][] read3DFloatArray(JsonReader reader) throws IOException {
