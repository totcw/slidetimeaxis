...
import com.lyf.bookreader.api.download.DownloadProgressInterceptor;
...
public class DownloadAPI {
    ...
    public void downloadAPK(String filename,String page, final File file, Subscriber subscriber) {
